...
type UserRepossitoryInterfase interface {
	GetUserByEmail(ctx context.Context, emial string) (*entity.UserEntity, error)
}
...
func NewUserRepository(db *gorm.DB) UserRepossitoryInterfase {
